    ...
    <div className="h-screen overflow-hidden">
      ...
      <div className="grid h-full grid-cols-12 gap-4 p-4">
        <div className="col-span-3">
          <Card className={`h-full p-4 overflow-hidden bg-transparent/0 border border-white/10 ${animateIn ? 'animate-in fade-in slide-in-from-left-8 duration-700' : ''}`}>
            <NarrativePanel />
          </Card>
        </div>
        ...
        <div className={`relative col-span-6 ${animateIn ? 'animate-in fade-in duration-700 delay-150' : ''} transform-gpu will-change-transform`}>
          ...
          <div className="pointer-events-none absolute left-1/2 top-4 z-10 -translate-x-1/2 select-none">
            ...
            <div className="col-span-3">
              <Card className="h-full p-4 overflow-hidden bg-transparent/0 border border-white/10">
                <ActionHUD />
              </Card>
            </div>
      </div>
